    ...
    <motion.article variants={list} initial="initial" animate="animate" className="flex flex-col gap-6">
      ...
      <motion.header variants={item} className="relative border-2 border-paper/80 p-5">
        ...
        <div className="mt-4 flex items-end justify-between border-t border-paper/20 pt-3">
          <div>
            <p className="font-mono font-semibold text-label tracking-[0.22em] text-paper/70">DAILY TARGET</p>
          ...
          <p className="max-w-[9rem] text-right font-mono font-semibold text-micro leading-relaxed tracking-[0.15em] text-paper/60">
      ...
      <Clause variants={item} index="§2" title="The Blender Battle Shake">
        <div className="border border-paper/15">
          <p className="border-b border-paper/15 px-4 py-3 font-mono font-semibold text-label tracking-[0.2em] text-paper/70">
          ...
          <p className="border-t border-paper/15 px-4 py-3 font-mono font-semibold text-label tracking-[0.2em] text-paper/60">
...
function Ingredient({ qty, name }: { qty: string; name: string }) {
  return (
    <li className="flex flex-col gap-0.5 px-4 py-3">
      <span className="font-mono text-label font-normal tabular tracking-[0.2em] text-paper/70">{qty.toUpperCase()}</span>
...
function Meal({ time, name, children }: { time: string; name: string; children: ReactNode }) {
  return (
    <li className="py-3">
      <p className="font-mono font-semibold text-label tracking-[0.22em] text-paper/70">{time}</p>
